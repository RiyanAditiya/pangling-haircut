<div>
    ...
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Kelola data user Pangling Haircut') }}</flux:subheading>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mt-5 mb-2">
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate href="{{ route('admin.userCreate') }}" id="createProductModalButton"
                            ...
                            @forelse ($users as $user)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a wire:navigate href="{{ route('admin.detailUser', $user->id) }}"
                                            class="focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-2 me-1 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Detail</a>
        ...
        @if ($deleteId)
            <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-lg w-96 p-6">
                    ...
                    <p class="mt-2 text-gray-600">Apakah Anda yakin ingin menghapus user ini?</p>
