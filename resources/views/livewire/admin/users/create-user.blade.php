<div>
    ...
    <flux:subheading size="lg" class="mb-6">
        {{ __('Tambah data user Pangling Haircut') }}
    </flux:subheading>
    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mt-6">
        <form wire:submit.prevent="save" class="space-y-5">
            ...
            <div>
                ...
                <select id="role" wire:model="role"
                    class="w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 
                           dark:bg-gray-700 dark:border-gray-600 dark:text-white 
                           focus:ring-primary-500 focus:border-primary-500">
                    <option class="text-gray-500" value="">-- Pilih role --</option>
         ...
         ">
                    ...
                    <input type="file" x-ref="image" wire:model="image" accept="image/jpg, image/jpeg, image/png"
                        class="hidden">
