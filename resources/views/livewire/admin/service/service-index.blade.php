<div>
    ...
    <div class="relative mb-6 w-full">
        ...
        <flux:heading size="xl" level="1">{{ __('Layanan') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Kelola layanan Pangling Haircut') }}</flux:subheading>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mt-5 mb-2">
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate href="{{ route('admin.serviceCreate') }}" id="createProductModalButton"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-4">Nama Layanan</th>
                            ...
                            @forelse ($services as $service)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a wire:navigate href="{{ route('admin.serviceEdit', $service->id) }}"
        ...
        @if ($deleteId)
            <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-lg w-96 p-6">
                    ...
                    <p class="mt-2 text-gray-600">Apakah Anda yakin ingin menghapus layanan ini?</p>
